...
public class GoldenAppleInstantiator : MonoBehaviour
{
    [SerializeField] private float instantiateInterval = 5.0f;
    ...
    void Start()
    {
        InvokeRepeating(nameof(InstantiateApple), instantiateInterval, 5);
    }
